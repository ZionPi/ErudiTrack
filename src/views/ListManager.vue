...
export default {
  ...
  data() {
    return {
      lists: [
        { id: uuidv4(), name: 'Shopping List', items: ['Milk', 'Eggs', 'Bread'] },
        { id: uuidv4(), name: 'To Do', items: ['Walk dog', 'Buy groceries'] },
        { id: uuidv4(), name: 'Projects', items: ['Frontend', 'Backend', 'Design'] },
        { id: uuidv4(), name: 'Groceries', items: ['Apples', 'Bananas', 'Oranges'] },
        { id: uuidv4(), name: 'Books to Read', items: ['Book 1', 'Book 2', 'Book 3'] },
        { id: uuidv4(), name: 'Movies to Watch', items: ['Movie A', 'Movie B', 'Movie C'] },
        { id: uuidv4(), name: 'Another List', items: [] },
        { id: uuidv4(), name: 'Yet Another List', items: [] },
        { id: uuidv4(), name: 'A Very Long List Name Example 1', items: [] },
        { id: uuidv4(), name: 'A Very Long List Name Example 2', items: [] },
        { id: uuidv4(), name: 'A Very Long List Name Example 3', items: [] },
        { id: uuidv4(), name: 'A Very Long List Name Example 4', items: [] },
        { id: uuidv4(), name: 'A Very Long List Name Example 5', items: [] },
        { id: uuidv4(), name: 'A Very Long List Name Example 1', items: [] },
        { id: uuidv4(), name: 'A Very Long List Name Example 2', items: [] },
        { id: uuidv4(), name: 'A Very Long List Name Example 3', items: [] },
        { id: uuidv4(), name: 'A Very Long List Name Example 4', items: [] },
